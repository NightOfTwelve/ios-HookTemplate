...
@class SBLockScreenBatteryChargingViewController, SBLockScreenTemperatureWarningViewController, SBLoginAppContainerPluginWrapperViewController, SBAppStatusBarSettingsAssertion, NSString;
...
-(id)initWithNibName:(id)arg1 bundle:(id)arg2 sceneHoster:(id)arg3 ;
...
-(id)initWithSceneHoster:(id)arg1 ;
