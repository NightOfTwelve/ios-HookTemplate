...
@class NSArray, NSString, SBAppVisibilityPreferences, NSDictionary, NSSet;
...
@interface SBApplicationInfo : FBApplicationInfo {
	...
	NSArray* _tags;
	SBAppVisibilityPreferences* _iconVisibilityOverride;
...
@property (nonatomic,readonly) SBAppVisibilityPreferences * iconVisibilityOverride;                          //@synthesize iconVisibilityOverride=_iconVisibilityOverride - In the implementation block
...
-(id)_parseAppVisibilityPreferenceIfDefined:(id)arg1 ;
-(id)_parseAppTags:(id)arg1 appVisibilityOverride:(id)arg2 ;
...
-(BOOL)_isiPad;
-(SBAppVisibilityPreferences *)iconVisibilityOverride;
